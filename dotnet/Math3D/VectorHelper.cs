...
namespace Ara3D
{
    public static class VectorHelper
    {
        ...
        public static float ProductComponents(this Vector3 self)
        {
            return self.X * self.Y * self.Z;
        }
        ...
        {
            return new Vector3(
                MathOps.Barycentric(value1.X, value2.X, value3.X, amount1, amount2),
                MathOps.Barycentric(value1.Y, value2.Y, value3.Y, amount1, amount2),
                MathOps.Barycentric(value1.Z, value2.Z, value3.Z, amount1, amount2));
        }
