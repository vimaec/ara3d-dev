...
void DisplayContent(FbxNode* pNode)
{
    ...
    else
    {
        ...
        case FbxNodeAttribute::eMarker:  
            FBXSDK_printf("Marker Node Attribute\n\n");
            //DisplayMarker(pNode);
            break;

        case FbxNodeAttribute::eSkeleton:  
            FBXSDK_printf("Skeleton Node Attribute\n\n");
            //DisplaySkeleton(pNode);
            break;

        case FbxNodeAttribute::eMesh:      
            FBXSDK_printf("Mesh Node Attribute\n");
            DisplayMesh(pNode);
            break;

        case FbxNodeAttribute::eNurbs:      
            FBXSDK_printf("NURBs Node Attribute\n\n");
            //DisplayNurb(pNode);
            break;

        case FbxNodeAttribute::ePatch:     
            FBXSDK_printf("PatchNode Attribute\n\n");
            //DisplayPatch(pNode);
            break;

        case FbxNodeAttribute::eCamera:    
            FBXSDK_printf("Camera Node Attribute\n\n");
            //DisplayCamera(pNode);
            break;

        case FbxNodeAttribute::eLight:     
            FBXSDK_printf("Light Node Attribute\n\n");
            //DisplayLight(pNode);
            break;

        case FbxNodeAttribute::eLODGroup:
            FBXSDK_printf("LOD Group Node Attribute\n\n");
